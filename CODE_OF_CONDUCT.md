...
Les cas de comportements abusifs, harcelants ou tout autre comportement inacceptables peuvent être signalés aux mainteneur·euse·s de l'organisation Kanibal Studio, responsables de l'application du code de conduite. En attendant une adresse dédiée, ouvrez une issue « Question » sur [kanibal-studio/.github](https://github.com/kanibal-studio/.github/issues/new/choose) en demandant un échange privé, sans détailler l'incident publiquement : un·e mainteneur·euse vous proposera un canal confidentiel.
